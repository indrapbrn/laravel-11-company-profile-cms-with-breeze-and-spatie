                ...
                @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <select name="type" id="type" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            ...
                            <option value="Missions" {{ $about->type == 'Missions' ? 'selected' : '' }}>Mssions</option>
                        </select>
                    ...
                    <h3 class="text-indigo-950 text-lg font-bold mt-4">Keypoints</h3>
                        ...
                        <div class="flex flex-col gap-y-5">
                            <x-input-label for="keypoints"/> 
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" value="{{ $about->keypoints[1]->keypoint ?? '' }}" name="keypoints[]">
                        </div>

                        <div class="flex flex-col gap-y-5">
                            <x-input-label for="keypoints"/> 
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" value="{{ $about->keypoints[2]->keypoint ?? '' }}" name="keypoints[]">
                        </div>
